...
const Header = ({
  ...
  onLogoutModalChange?: (shown: boolean) => void;
  setLogoutModal?: (modal: JSX.Element | null) => void;
}) => {
  ...
  if (user) {
    return (
      <div className="relative">
        <div
          className={`bg-[#50141c] text-white flex flex-row items-center justify-center relative z-50 ${
            isLogoutModalShown ? 'pointer-events-none select-none' : ''
          }`}>
